...
- The specific task group(s) from `droidz/specs/[this-spec]/tasks.md` including the parent task, all sub-tasks, and any sub-bullet points
...
4. Update `droidz/specs/[this-spec]/tasks.md` to mark completed tasks with `- [x]`
