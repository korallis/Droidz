...
{{PHASE 1: @droidz/commands/implement-tasks/1-determine-tasks.md}}

{{PHASE 2: @droidz/commands/implement-tasks/2-implement-tasks.md}}

{{PHASE 3: @droidz/commands/implement-tasks/3-verify-implementation.md}}
