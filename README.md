...
[![Version](https://img.shields.io/badge/version-3.1.3-blue.svg)](https://github.com/korallis/Droidz)
...
```bash
wget https://raw.githubusercontent.com/korallis/Droidz/v3.1.3/install.sh
chmod +x install.sh
./install.sh
```
