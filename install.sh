...
#
# Or download and run:
#   wget https://raw.githubusercontent.com/korallis/Droidz/v3.4.2/install.sh
#   chmod +x install.sh
#   ./install.sh
#
...
uninstall_droidz() {
    ...
    if [[ "$confirm" == "yes" ]]; then
        ...
        echo "  curl -fsSL https://raw.githubusercontent.com/korallis/Droidz/v3.4.2/install.sh | bash"
        exit 0
    else
