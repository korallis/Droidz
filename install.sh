...
echo ""
echo "3. Initialize Droidz Framework:"
echo "   /droidz-init"
echo "   This sets up directories, tech stack detection, and applies"
echo "   the Factory.ai compatibility workaround automatically."
echo ""
echo "4. Verify droids loaded:"
echo "   /droids"
echo "   Should see: droidz-orchestrator, droidz-codegen, etc."
echo ""

echo "5. Add MCP servers (optional):"
echo "   /mcp add exa      → AI/code research"
echo "   /mcp add linear   → Project management"
echo "   /mcp add ref      → Documentation lookup"
echo ""
echo "6. Explore the workflow:"
